  ...
  <div
    ...
    <div class="flex flex-row justify-between items-center">
      ...
      <div class="flex flex-row gap-1">
        ...
        <span class="righteous font-medium">{{ course.classqty }}</span>
      </div>

      <span class="bg-blue-default/75 px-2 py-1 text-white-80 rounded-lg">{{
        course.nivel
      }}</span>
      ...
      <div class="flex flex-row gap-1">
        ...
        <span class="righteous font-medium">{{ course.time }}h</span>
      </div>
    </div>
  </div>
</template>
