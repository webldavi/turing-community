...
<style>
.article {
  @apply w-full min-h-screen px-8 sm:px-16 flex flex-col lg:flex-row gap-8 pt-8;
}
.section_1 {
...
.section_1 > .aboutCourse > div > .countHour {
  @apply w-max flex flex-row gap-2 items-center justify-center;
}
...
.section_1 > .lessonList {
  @apply flex-col gap-4 hidden lg:flex;
}
...
.section_2 > .aboutLesson {
  @apply w-full px-4 py-2 rounded-lg border-2 border-gray-400 flex flex-col justify-between ;
}
.section_2 >.aboutLesson > .infoLesson {
  @apply w-full flex flex-row justify-between items-center;
}
.section_2 > .aboutLesson > .infoLesson > h1 {
  @apply text-2xl;
}
.section_2 > .aboutLesson > div > div {
  @apply w-max flex flex-row gap-2 items-center justify-center;
}
.section_2 > .aboutLesson > .infoLesson > div > .icon {
  @apply p-2 bg-blue-default/75 h-max w-max rounded-lg;
}
.section_2 > .aboutLesson > .infoLesson > div > .icon-name {
  @apply flex flex-col;
}
</style>
